...
**Capabilities:** booleans `protect`, `debt_weighting`, `chaos`, `replay`, `lab`; `max_live_members: integer 1–5`; `max_lab_members: integer 1–5000`; `cpsat: literal false`; `hardware: literal false`; `sglang_explanation: boolean` (false unless optional 22 passes). UI disables unavailable actions and states why.
